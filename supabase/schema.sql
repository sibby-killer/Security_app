/*
  # Community Security Alert App Database Schema
...
BEGIN
  ...
  IF NEW.reporter_id IS NOT NULL THEN
    PERFORM create_incident_notification(
      ...
      'Your incident has been assigned to security personnel for handling.',
      1,
      false
    );
  END IF;
...
BEGIN
  ...
  SELECT reporter_id, assigned_to INTO incident_record
  ...
  IF incident_record.reporter_id IS NOT NULL THEN
    PERFORM create_incident_notification(
      ...
      'Security personnel have submitted feedback for your incident. Please review and approve.',
      2,
      true
    );
  END IF;
  ...
  LOOP
    PERFORM create_incident_notification(
      ...
      NEW.incident_id,
      'feedback_submitted',
      'Feedback Submitted for Incident',
      'Security personnel have submitted feedback for incident. Please review and approve.',
      2,
      true
    );
  END LOOP;
...
-- Triggers for incident notifications
